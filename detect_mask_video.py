...
cred = credentials.Certificate('C:/CampKioskSystem/mykey.json')
...
while True:
	...
	for (box, pred) in zip(locs, preds):
		...
		label = "Check Temperature When Video Stops"
		cv2.line(frame, (0, 950), (700, 950), color, 100)
		cv2.putText(frame, label, (50, 950), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255,255,255), 3)
